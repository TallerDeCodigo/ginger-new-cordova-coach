...
Swipe.prototype = {
  ...
  slide: function(index, duration) {
    ...
    $(".priv-public .btn-platillo").removeClass("active");
    $(".priv-public .btn-platillo:nth-of-type("+actual+")").addClass("active");
...
// $(function(){
//   $('.name_platillo').autogrow({vertical: true, horizontal: false,flickering: false});
